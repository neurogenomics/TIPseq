...
Import the full genome-wide ENCODE data 
(`encode_H3K27ac` only includes chromosome 1).

```{r}
encode <- import.narrowPeak(con = "https://www.encodeproject.org/files/ENCFF044JNJ/@@download/ENCFF044JNJ.bed.gz")
names(encode) <- paste("H3K27ac_K562_ENCODE_ENCFF044JNJ",encode$name,sep=".")
```
...
out <- EpiCompare(peakfiles = peakfiles2, 
